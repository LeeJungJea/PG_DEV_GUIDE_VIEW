...
const Playground: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold tracking-tight text-on-surface mb-2">API ?åÏä§??/h1>
        <p className="text-zinc-500 text-sm">CJ ONE Í≤∞Ï†ú APIÎ•??§ÏãúÍ∞ÑÏúºÎ°??åÏä§?∏ÌïòÍ≥??ëÎãµ ?∞Ïù¥?∞Î? ?ïÏù∏?òÏÑ∏??</p>
      </div>
    ...
    "installment_month": 0
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-surface-container-low rounded-xl p-6 hover:bg-white transition-all cursor-pointer group border border-transparent hover:border-zinc-200 shadow-sm">
          ...
          <p className="text-xs text-zinc-500 leading-relaxed">?πÏù∏ API???ÅÏÑ∏ Î™ÖÏÑ∏?Ä ?êÎü¨ ÏΩîÎìúÎ•??ïÏù∏?òÎ†§Î©?Î¨∏ÏÑúÎ•?Ï∞∏Ï°∞?òÏÑ∏??</p>
        </div>
        <div className="bg-surface-container-low rounded-xl p-6 hover:bg-white transition-all cursor-pointer group border border-transparent hover:border-zinc-200 shadow-sm">
          ...
          <p className="text-xs text-zinc-500 leading-relaxed">ÏµúÍ∑º 24?úÍ∞Ñ ?ôÏïà Î∞úÏÉù???åÏä§???îÏ≤≠ Í∏∞Î°ù??Ï°∞Ìöå?©Îãà??</p>
        </div>
        <div className="bg-surface-container-low rounded-xl p-6 hover:bg-white transition-all cursor-pointer group border border-transparent hover:border-zinc-200 shadow-sm">
          ...
          <p className="text-xs text-zinc-500 leading-relaxed">?åÏä§???òÍ≤Ω?êÏÑú ?¨Ïö©???åÎìúÎ∞ïÏä§ API ?§Î? Í¥ÄÎ¶¨Ìïò?∏Ïöî.</p>
        </div>
      </div>
    </div>
  );
