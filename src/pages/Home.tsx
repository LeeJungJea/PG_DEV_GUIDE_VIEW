        ...
        <div className="max-w-screen-2xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="z-10 animate-in slide-in-from-left-8 duration-700">
            ...
            <p className="text-lg text-zinc-500 leading-relaxed mb-10 max-w-xl font-medium">
              강력한 API, 실제와 동일한 샌드박스 테스트 환경, 그리고 실시간 기술 지원까지.
              <br />
              개발자를 위한 최적의 결제 워크플로를 지금 경험해보세요.
            </p>
          ...
          <div className="relative animate-in slide-in-from-right-8 duration-1000">
            ...
            <div className="relative bg-white/70 backdrop-blur-xl rounded-[32px] shadow-[0_8px_32px_rgba(246,0,166,0.1)] p-8 border border-white overflow-hidden transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="absolute bottom-6 right-8 bg-zinc-100 text-primary px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase">
                Ready to Deploy
              </div>
            </div>
          </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="animate-in slide-in-from-bottom-4 duration-700">
              ...
              <p className="text-zinc-500 max-w-xl font-medium">몇 줄의 코드로 복잡한 결제 프로세스를 간편하게 제어해보세요.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-zinc-500 mb-8 max-w-md font-medium leading-relaxed">신용카드, 간편결제, 계좌이체 등 다양한 결제 수단을 단일 인터페이스로 통합 제공합니다.</p>
            ...
            >
              ...
              <p className="text-sm text-zinc-500 leading-relaxed font-medium">부분 취소, 전액 취소 등 유연한 환불 정책을 코드 몇 줄로 처리할 수 있습니다.</p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-zinc-500 leading-relaxed font-medium">실시간 결제 상태 추적을 통해 누락 없는 데이터 동기화를 보장합니다.</p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-12 items-center relative z-10">
                <div className="flex-1">
                  ...
                  <p className="text-white/60 font-medium leading-relaxed">가상 데이터를 사용하여 실제 결제와 동일한 플로우를 안전하게 테스트하고 검증하세요.</p>
                </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative group">
              <div className="absolute inset-0 bg-primary/20 rounded-[32px] blur-3xl opacity-0 group-hover:opacity-40 transition-opacity duration-700" />
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-[24px] shadow-2xl z-20 border border-zinc-100 max-w-[320px] animate-in zoom-in duration-700">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-black text-zinc-900">보안 인증 준수</span>
                </div>
            ...
            <div className="space-y-12">
              <div>
                <h2 className="text-4xl font-extrabold tracking-tight mb-6 text-zinc-900 leading-tight">
                  신뢰할 수 있는
                  <br />
                  기술 파트너
                </h2>
                <p className="text-lg text-zinc-500 font-medium leading-relaxed">CJ PG는 99.99% 이상의 가용성을 보장하며, 대규모 트래픽에서도 흔들림 없는 결제 환경을 제공합니다.</p>
              </div>
