  ...
  return (
    <div className="max-w-5xl">
      ...
      <section className="mb-12">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight text-on-surface mb-6 font-headline">결제 ?�태 조회</h1>
        <p className="text-lg text-zinc-600 max-w-3xl leading-relaxed italic">
          가맹점 주문 번호(orderId)�?기반?�로 ?�당 결제???�재 ?�태 �??�세 ?�역???�시간으�?조회?�니??
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest border-b border-zinc-100">
                  <tr>
                    <th className="pb-4">?�드�?/th>
                    <th className="pb-4">?�??/th>
                    <th className="pb-4">?�명</th>
                  </tr>
                </thead>
                <tbody className="text-sm divide-y divide-zinc-50 italic">
                  <tr>
                    ...
                    <td className="py-5 text-zinc-600">조회??가맹점 주문 번호 <span className="text-error text-[10px] font-bold ml-2 uppercase tracking-tighter">Required</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="bg-zinc-50 rounded-xl p-8 border border-zinc-200/50">
             <h3 className="text-sm font-bold text-zinc-500 mb-4 uppercase tracking-widest">결제 ?�태 구분 (Status)</h3>
